...
class RSSFeedTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.rss_feed = RSSFeed.objects.create(
            link='https://www.omnycontent.com/d/playlist/e72c998e-6e60-432f-8610-ae210140c5b1/e7fd5ae7-7621-4e41-9b85-b0ab0164b634/4c1a5135-4197-47c9-b19b-b0ab0164b667/podcast.rss',  # Example public RSS feed
        )
