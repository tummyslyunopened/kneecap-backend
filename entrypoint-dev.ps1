...
Start-Process -FilePath "uv" -ArgumentList "run manage.py record_minutes" -RedirectStandardOutput "./logs/record-minutes-output.log" -RedirectStandardError "./logs/record-minutes-error.log" -NoNewWindow

# Use Get-Content to follow the logs
Get-Content ./logs/runserver-output.log, ./logs/runserver-error.log, ./logs/sync-rss-data-output.log, ./logs/sync-rss-data-error.log, ./logs/download-media-output.log, ./logs/download-media-error-log, ./logs/transcribe-episodes-output.log, ./logs/transcribe-episodes-error-log, ./logs/generate-low-quality-output.log, ./logs/generate-low-quality-error-log, ./logs/detect-ads-output.log, ./logs/detect-ads-error.log, ./logs/record-minutes-output.log, ./logs/record-minutes-error.log -Wait
