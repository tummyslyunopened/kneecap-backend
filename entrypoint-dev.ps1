...
Get-Content ./logs/runserver-output.log, ./logs/runserver-error.log, ./logs/rss-episode-downloader-output.log, ./logs/rss-episode-downloader-error.log, ./logs/rss-subscriptions-refresher-output.log, ./logs/rss-subscriptions-refresher-error.log -Wait